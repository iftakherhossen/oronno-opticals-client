    ...
    return (
        <Container>
            <Grid container spacing={2}>
                <Grid item xs={12} md={4} sx={{ mx: 'auto', backgroundImage: 'url(https://i.ibb.co/C60Qdd8/login-bg.jpg)' }}>
                    <form onSubmit={handleLogin} style={{ padding: '95px 0', textAlign: 'center' }}>
                        ...
                        <Button variant="contained" sx={{ mt: 3 }} className="customBgColor" onClick={handleGoogleSignIn}>Login With Google</Button><br /> <br />
